...
export class AppCart {
  ...
  render() {
    ...
    const navigateWithState = () => {
      localStorage.setItem('pageState', JSON.stringify({ isPromoTrue }));
        ...
        {!isLoading && (
          <app-layout>
            ...
            <div class="flex flex-col gap-3 sm:gap-5">
                ...
                {!isPromoTrue && (
                  <Fragment>
                    ...
                    <div class="bg-gray-50 border rounded-md flex items-center gap-2 p-1">
                      ...
                      />
                      <button onClick={this.handlePromoApply} class="bg-[#004d5a] text-white text-xs px-2 py-1 rounded-md">
                        Apply
                      </button>
                    </div>
                  </Fragment>
              ...
              {/* Proceed Button */}
              <button onClick={() => navigateWithState()} class="bg-[#004d5a] text-white text-sm font-normal p-3 rounded-md">
                Proceed to shipping
              </button>
            </div>
          </app-layout>
